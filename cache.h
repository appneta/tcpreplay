...
struct cache_type {
 ...
 /* cache_file_header
    Data structure defining a file as a tcpprep cache file and it's version

    If you need to enhance this struct, do so AFTER the version field and 
    be sure to increment  CACHEVERSION
 */
