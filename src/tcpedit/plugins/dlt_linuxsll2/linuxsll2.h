 ...
 *   Copyright (c) 2013-2023 Fred Klassen <tcpreplay.dev at gmail dot com> - AppNeta by Broadcom
 *
...
#ifndef _DLT_linuxsll2_H_
#define _DLT_linuxsll2_H_
...
int dlt_linuxsll2_decode(tcpeditdlt_t *ctx, const u_char *packet, const int pktlen);
