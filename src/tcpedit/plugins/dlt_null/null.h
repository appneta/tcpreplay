...
int dlt_null_decode(tcpeditdlt_t *ctx, const u_char *packet, int pktlen);
int dlt_null_encode(tcpeditdlt_t *ctx, u_char *packet, int pktlen, tcpr_dir_t dir);
int dlt_null_proto(tcpeditdlt_t *ctx, const u_char *packet, int pktlen);
u_char *dlt_null_get_layer3(tcpeditdlt_t *ctx, u_char *packet, int pktlen);
u_char *
...
int dlt_null_l2len(tcpeditdlt_t *ctx, const u_char *packet, int pktlen);
u_char *dlt_null_get_mac(tcpeditdlt_t *ctx, tcpeditdlt_mac_type_t mac, const u_char *packet, int pktlen);
