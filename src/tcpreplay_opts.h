...
typedef enum {
    ...
    INDEX_OPT_INTF2              = 10,
    INDEX_OPT_WRITE              = 11,
    INDEX_OPT_INCLUDE            = 12,
    INDEX_OPT_EXCLUDE            = 13,
    INDEX_OPT_LISTNICS           = 14,
    INDEX_OPT_LOOP               = 15,
    INDEX_OPT_LOOPDELAY_MS       = 16,
    INDEX_OPT_LOOPDELAY_NS       = 17,
    INDEX_OPT_PKTLEN             = 18,
    INDEX_OPT_LIMIT              = 19,
    INDEX_OPT_DURATION           = 20,
    INDEX_OPT_MULTIPLIER         = 21,
    INDEX_OPT_PPS                = 22,
    INDEX_OPT_MBPS               = 23,
    INDEX_OPT_TOPSPEED           = 24,
    INDEX_OPT_ONEATATIME         = 25,
    INDEX_OPT_PPS_MULTI          = 26,
    INDEX_OPT_UNIQUE_IP          = 27,
    INDEX_OPT_UNIQUE_IP_LOOPS    = 28,
    INDEX_OPT_NETMAP             = 29,
    INDEX_OPT_NM_DELAY           = 30,
    INDEX_OPT_NO_FLOW_STATS      = 31,
    INDEX_OPT_FLOW_EXPIRY        = 32,
    INDEX_OPT_PID                = 33,
    INDEX_OPT_STATS              = 34,
    INDEX_OPT_SUPPRESS_WARNINGS  = 35,
    INDEX_OPT_XDP                = 36,
    INDEX_OPT_XDP_BATCH_SIZE     = 37,
    INDEX_OPT_IO_URING           = 38,
...
#define VALUE_OPT_PPS_MULTI      0x1009

#define OPT_VALUE_PPS_MULTI      (DESC(PPS_MULTI).optArg.argInt)
#define VALUE_OPT_UNIQUE_IP      0x100A
#define VALUE_OPT_UNIQUE_IP_LOOPS 0x100B
#define VALUE_OPT_NETMAP         0x100C
#define VALUE_OPT_NM_DELAY       0x100D
#ifdef HAVE_NETMAP
#define OPT_VALUE_NM_DELAY       (DESC(NM_DELAY).optArg.argInt)
#endif /* HAVE_NETMAP */
#define VALUE_OPT_NO_FLOW_STATS  0x100E
#define VALUE_OPT_FLOW_EXPIRY    0x100F

#define OPT_VALUE_FLOW_EXPIRY    (DESC(FLOW_EXPIRY).optArg.argInt)
#define VALUE_OPT_PID            'P'
#define VALUE_OPT_STATS          0x1010
...
#define SET_OPT_SUPPRESS_WARNINGS   STMTS( \
        DESC(SUPPRESS_WARNINGS).optActualIndex = 35; \
...
#define VALUE_OPT_XDP            0x1011
#define VALUE_OPT_XDP_BATCH_SIZE 0x1012
#ifdef HAVE_LIBXDP
#define OPT_VALUE_XDP_BATCH_SIZE (DESC(XDP_BATCH_SIZE).optArg.argInt)
#endif /* HAVE_LIBXDP */
#define VALUE_OPT_IO_URING       0x1013
...
#define VALUE_OPT_SAVE_OPTS     0x1014
/** option flag (value) for load-opts-value option */
#define VALUE_OPT_LOAD_OPTS     0x1015
