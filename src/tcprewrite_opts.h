...
typedef enum {
    ...
    INDEX_OPT_DBUG                      = 37,
    INDEX_OPT_INFILE                    = 38,
    INDEX_OPT_OUTFILE                   = 39,
    INDEX_OPT_CACHEFILE                 = 40,
    INDEX_OPT_VERBOSE                   = 41,
    INDEX_OPT_DECODE                    = 42,
    INDEX_OPT_FRAGROUTE                 = 43,
    INDEX_OPT_FRAGDIR                   = 44,
    INDEX_OPT_SKIP_SOFT_ERRORS          = 45,
    INDEX_OPT_VERSION                   = 46,
    INDEX_OPT_LESS_HELP                 = 47,
    INDEX_OPT_SUPPRESS_WARNINGS         = 48,
    INDEX_OPT_HELP                      = 49,
...
#define SET_OPT_CACHEFILE(a)   STMTS( \
        DESC(CACHEFILE).optActualIndex = 40; \
...
#define VALUE_OPT_FRAGROUTE      0x101A
#define VALUE_OPT_FRAGDIR        0x101B
#define VALUE_OPT_SKIP_SOFT_ERRORS 0x101C
#define VALUE_OPT_VERSION        'V'
#define VALUE_OPT_LESS_HELP      'h'
#define VALUE_OPT_SUPPRESS_WARNINGS 'w'

#define SET_OPT_SUPPRESS_WARNINGS   STMTS( \
        DESC(SUPPRESS_WARNINGS).optActualIndex = 48; \
...
#define VALUE_OPT_SAVE_OPTS     0x101D
/** option flag (value) for load-opts-value option */
#define VALUE_OPT_LOAD_OPTS     0x101E
